...
(function(root, factory) {
  ...
  describe('CamerasApi', function() {
    describe('getCameras', function() {
      it('should call getCameras successfully', function(done) {
        //uncomment below and update the code to test getCameras
        //instance.getCameras(function(error) {
