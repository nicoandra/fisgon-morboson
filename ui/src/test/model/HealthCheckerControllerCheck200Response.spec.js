...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.HealthCheckerControllerCheck200Response();
  });
  ...
  describe('HealthCheckerControllerCheck200Response', function() {
    it('should create an instance of HealthCheckerControllerCheck200Response', function() {
      // uncomment below and update the code to test HealthCheckerControllerCheck200Response
      //var instance = new Api.HealthCheckerControllerCheck200Response();
      //expect(instance).to.be.a(Api.HealthCheckerControllerCheck200Response);
    });
