...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Api.HealthCheckerControllerCheck200ResponseInfoValue();
  });
  ...
  describe('HealthCheckerControllerCheck200ResponseInfoValue', function() {
    it('should create an instance of HealthCheckerControllerCheck200ResponseInfoValue', function() {
      // uncomment below and update the code to test HealthCheckerControllerCheck200ResponseInfoValue
      //var instance = new Api.HealthCheckerControllerCheck200ResponseInfoValue();
      //expect(instance).to.be.a(Api.HealthCheckerControllerCheck200ResponseInfoValue);
    });
